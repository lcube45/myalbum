...
/**
 * Provides a form for reverting a Artist revision for a single translation.
 *
 * @ingroup myalbum
 */
class ArtistEntityRevisionRevertTranslationForm extends ArtistEntityRevisionRevertForm {
  ...
  /**
   * Constructs a new ArtistEntityRevisionRevertTranslationForm.
   *
  ...
  protected function prepareRevertedRevision(ArtistEntityInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\myalbum\Entity\ArtistEntityInterface $default_revision */
    $latest_revision = $this->ArtistEntityStorage->load($revision->id());
